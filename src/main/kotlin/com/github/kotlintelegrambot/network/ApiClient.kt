...
internal class ApiClient(
    ...
    suspend fun getUpdates(
        ...
        return try {
            ...
            apiResponseMapper.mapToTelegramBotResult(updates)
    ...
    suspend fun getMe(): TelegramBotResult<User> {
        return try {
            apiResponseMapper.mapToTelegramBotResult(service.getMe())
        }
        catch (excpetion: Exception){
            TelegramBotResult.Error.Unknown(excpetion)
        }
    }
    ...
    suspend fun sendMessage(
        ...
        return try {
            apiResponseMapper.mapToTelegramBotResult(service.sendMessage(
                chatId,
                text,
                parseMode,
    ...
    suspend fun forwardMessage(
        ...
        return try {
            apiResponseMapper.mapToTelegramBotResult(service.forwardMessage(
                chatId,
                fromChatId,
                disableNotification,
                messageId,
    ...
    suspend fun sendMediaGroup(
        ...
        return try {
            apiResponseMapper.mapToTelegramBotResult(service.sendMediaGroup(sendMediaGroupMultipartBody))
        }catch (exception: Exception){
            TelegramBotResult.Error.Unknown(exception)
        }
    }
    ...
    fun getMyCommands(): TelegramBotResult<List<BotCommand>> =
        service.getMyCommands().runApiOperation()
